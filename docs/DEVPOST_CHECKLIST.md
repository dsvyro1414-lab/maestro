...
- **Gallery images** (Devpost crops to 3:2; export ~1200x800 or larger). Take these 5:
  ...
  4. Terminal screenshot: 20 passing synthetic-landmark tests
...
- **"Try it out" links:** https://github.com/dsvyro1414-lab/maestro + https://maestro-lemon.vercel.app. The Spotify app is in development mode, so judges' Spotify emails must be added under User Management in the Spotify dashboard. Add a one-line note near the link: "Click *Start conducting — instant demo* to try the gestures right now, no account needed. (Spotify mode is fully implemented but Spotify's dev-mode policy limits logins to whitelisted Premium accounts.)"
